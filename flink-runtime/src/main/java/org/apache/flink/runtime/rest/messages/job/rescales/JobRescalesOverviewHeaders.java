...
public class JobRescalesOverviewHeaders
    ...
    public static final JobRescalesOverviewHeaders INSTANCE = new JobRescalesOverviewHeaders();
    public static final String JOB_RESCALES_OVERVIEW_PATH = "/jobs/:jobid/rescales/overview";
